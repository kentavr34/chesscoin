# docs/safety/SAFETY_POLICY.md — Политика безопасности изменений
...
1. `MASTER_PLAN.md`
2. `docs/product/ROADMAP_V3.md` — какая текущая фаза, какие фазы НЕ начаты.
3. `docs/product/MECHANICS.md` — целевая механика.
