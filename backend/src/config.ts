...
const config = {
  ...
  economy: {
    ...
    botRewards: {
      ...
      4:  bigint("BOT_REWARD_4",  4000n),
      5:  bigint("BOT_REWARD_5",  5000n),
      6:  bigint("BOT_REWARD_6",  6000n),
      7:  bigint("BOT_REWARD_7",  7000n),
      8:  bigint("BOT_REWARD_8",  8000n),
      9:  bigint("BOT_REWARD_9",  9000n),
      10: bigint("BOT_REWARD_10", 10000n),
