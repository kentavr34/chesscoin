...
const config = {
  ...
  economy: {
    ...
    botRewards: {
      ...
      2:  bigint("BOT_REWARD_2",  2000n),
      3:  bigint("BOT_REWARD_3",  3000n),
      4:  bigint("BOT_REWARD_4",  5000n),
      5:  bigint("BOT_REWARD_5",  7000n),
      6:  bigint("BOT_REWARD_6",  10000n),
      7:  bigint("BOT_REWARD_7",  15000n),
      8:  bigint("BOT_REWARD_8",  20000n),
      9:  bigint("BOT_REWARD_9",  30000n),
      10: bigint("BOT_REWARD_10", 40000n),
      11: bigint("BOT_REWARD_11", 55000n),
      12: bigint("BOT_REWARD_12", 75000n),
      13: bigint("BOT_REWARD_13", 100000n),
      14: bigint("BOT_REWARD_14", 130000n),
      15: bigint("BOT_REWARD_15", 170000n),
      16: bigint("BOT_REWARD_16", 220000n),
      17: bigint("BOT_REWARD_17", 300000n),
      18: bigint("BOT_REWARD_18", 400000n),
      19: bigint("BOT_REWARD_19", 600000n),
      20: bigint("BOT_REWARD_20", 1000000n),
