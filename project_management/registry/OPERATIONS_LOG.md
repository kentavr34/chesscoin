...
| 22:35 | change | Войны, пункты 3-6: сортировка бойцов по ступеням, счёт против каждой страны, обнуление побед и история проверены по факту | — |
| 23:17 | change | Автопилот войны проверен живой войной на проверочных аккаунтах: партия создана, уведомления ушли, карточка видна. Война разобрана, капитал сходится | — |

## 2026-08-02

| Время | Вид | Что | Доказательство |
|---|---|---|---|
| 02:15 | fix | Окно PGN переделано в панель партии, нижняя панель после конца игры перестала предлагать сдаться, кнопка обучения перенесена в реальный модал | — |

## 2026-08-03

| Время | Вид | Что | Доказательство |
|---|---|---|---|
| 15:03 | fix | Вывод монет за TON закрыт по решению Кенана, 100 000 возвращены, капитал сошёлся. Биржа: цена показывается, курс в понятных единицах, кошелёк и биржа объединены в одну страницу | — |
| 17:07 | fix | Отвязка кошелька починена (не доходила до сервера). Комиссии подтверждены Кенаном: 0.5% крипта, 10% игра. Неподтверждённый кошелёк — наш собственный, отвязывать нельзя | — |

## 2026-08-04

| Время | Вид | Что | Доказательство |
|---|---|---|---|
| 10:44 | fix | Магазин: закрыта дыра /shop/ton/* (покупка монет без проверки платежа), починены стили фигур 9 из 10. Проверено покупкой на проде | — |
| 12:12 | feature | Магазин доведён: переводы товаров, звук как товар, рамка-свечение, формы клеток. Регрессия 43/43 | — |
| 22:26 | feature | B9 закрыт целиком: рамка-свечение, формы клеток, подсветка шаха и кольцо взятия. Регрессия 43/43 | — |
