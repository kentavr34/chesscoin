...
const ptab = (active: boolean): React.CSSProperties => ({ flex: '0 0 auto', textAlign: 'center', padding: '10px 12px', fontSize: 11, fontWeight: 600, color: active ? '#F5C842' : '#8B92A8', cursor: 'pointer', borderBottom: `2px solid ${active ? '#F5C842' : 'transparent'}`, background: 'none', fontFamily: 'inherit', transition: 'all .2s', whiteSpace: 'nowrap' } as any);
