...
const ptab = (active: boolean): React.CSSProperties => ({ flex: 1, textAlign: 'center', padding: '10px 0', fontSize: 11, fontWeight: 600, color: active ? '#F5C842' : '#8B92A8', cursor: 'pointer', borderBottom: `2px solid ${active ? '#F5C842' : 'transparent'}`, background: 'none', border: 'none', borderBottom: `2px solid ${active ? '#F5C842' : 'transparent'}`, fontFamily: 'inherit', transition: 'all .2s' } as any);
