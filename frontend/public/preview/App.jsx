  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {screen === 'game'    && <ScreenWrap title="Игра"><GameScreen /></ScreenWrap>}
        {screen === 'battles' && <ScreenWrap title="Батлы"><BattlesScreen /></ScreenWrap>}
        {screen === 'wars'    && <ScreenWrap title="Войны"><WarsScreen /></ScreenWrap>}
        {screen === 'profile' && <ScreenWrap title="Профиль"><ProfileScreen user={user} /></ScreenWrap>}
      </div>
